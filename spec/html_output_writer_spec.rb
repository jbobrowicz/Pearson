require_relative "../lib/html_output_writer"
require_relative "../lib/function_factory"

describe HtmlOutputWriter do
  def output_of_writer(input)
    output = StringIO.new
    output_writer = HtmlOutputWriter.new(output)
  ...
  it "should output objects supporting conversion to string" do
    ...
    output_of_writer([x, y]).should == "<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"/><title>Pearson</title></head><body><ul><li>a</li><li>b</li></ul></body></html>"
  end
end